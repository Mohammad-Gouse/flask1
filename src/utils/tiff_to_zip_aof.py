...
#         new_zip_file_name = new_zip_file_names(pdf_file_name)
#         print(new_zip_file_name)
#         zip_file_path = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/{new_zip_file_name}.zip'  # Change the format here
#         print("123")
        
#         # Check if total_size is less than 4MB
#         if total_size > 4 * 1024 * 1024:  # 4MB in bytes
#             # Create a new folder "CAMS_RTA" and save the zip file there
#             cams_rta_folder = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/CAMS_RTA'
...
#         # file_name = current_zip_file_name(pdf_file_name)
#         # print(file_name)
#         zip_file_paths = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/CAMS_RTA_{pdf_file_name}.zip'  # Change the format here
#         print("245")
...
#     total_size = current_zip_file_size + tiff_file_size
#     print(total_size) 
#     zip_file_path = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/{pdf_file_name}.zip'
#     if total_size>max_file_size_in_bytes:
#        new_zip_folder=f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/CAMS_RTA_{pdf_file_name}_{zip_folder_counter}'
#        zip_folder_counter+=zip_folder_counter
#        os.makedirs(new_zip_folder, exist_ok=True)
#        new_zip_file_path = os.path.join(new_zip_folder, os.path.basename(zip_file_path))
#        with zipfile.ZipFile(new_zip_file_path, 'w', zipfile.ZIP_DEFLATED) as zip_file:
#                 zip_file.write(tiff_path, arcname=tiff_filename)
#                 print(f"TIFF file '{tiff_filename}' converted to ZIP file '{new_zip_file_path}'.")
#                 os.remove(tiff_path)
...
#     else:
#         current_zip_folder=f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/CAMS_RTA_{pdf_file_name}'
#         os.makedirs(current_zip_folder, exist_ok=True)
#         new_zip_file_path = os.path.join(current_zip_folder, os.path.basename(zip_file_path))
#         with zipfile.ZipFile(new_zip_file_path, 'w', zipfile.ZIP_DEFLATED) as zip_file:
#                 zip_file.write(tiff_path, arcname=tiff_filename)
#                 print(f"TIFF file '{tiff_filename}' converted to ZIP file '{new_zip_file_path}'.")
#                 os.remove(tiff_path)
...
#     if total_size > max_file_size_in_bytes:
#         new_zip_folder = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/CAMS_RTA_{pdf_file_name}_{zip_folder_counter}'
#         zip_folder_counter += 1  # Increment the counter
#         os.makedirs(new_zip_folder, exist_ok=True)
#         new_zip_file_path = os.path.join(new_zip_folder, f'CAMS_RTA_{pdf_file_name}_{zip_folder_counter}.zip')
#     else:
#         new_zip_folder = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}/CAMS_RTA_{pdf_file_name}'
#         os.makedirs(new_zip_folder, exist_ok=True)
#         new_zip_file_path = os.path.join(new_zip_folder, f'CAMS_RTA_{pdf_file_name}.zip')
...
def convert_tiff_to_zip(tiff_path, pdf_file_name):
    zip_folder = f'{TRANSACTION_FILE_NAME}/aof/cams/{datetime.datetime.now().strftime("%Y/%B/%d")}'

    tiff_filename = os.path.basename(tiff_path)
    zip_filename = f'CAMS_RIA_{pdf_file_name}.zip'
